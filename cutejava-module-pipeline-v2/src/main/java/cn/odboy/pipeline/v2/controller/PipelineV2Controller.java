...
public class PipelineV2Controller {
  ...
  public ResponseEntity<?> testStart() {
    ...
    PipelineTemplateContextTb pipelineTemplateContext = pipelineTemplateContextService.getPipelineTemplateContext(
        clusterType, clusterCode, contextType,
        contextName
    );
    ...
    TaskContext execute = taskBuilder.execute();
    return ResponseEntity.ok(execute.getTaskId());
  }
